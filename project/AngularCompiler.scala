...
class AngularCompiler {
    ...
    def compile(path: String): String = {
        ...
        concatenate(
            (Path.fromString(".tmp/sources/app/be/moneyMaker/angular/") * "*.js")
                ++ (Path.fromString(".tmp/sources/app/be/moneyMaker/angular/services") ** "*.js")
                ++ (Path.fromString(".tmp/sources/app/be/moneyMaker/angular/filters") ** "*.js")
                ++ (Path.fromString(".tmp/sources/app/be/moneyMaker/angular/directives") ** "*.js")
                ++ (Path.fromString(".tmp/sources/app/be/moneyMaker/angular/controllers") ** "*.js")
